...
class WindowModel(NERModel):
    ...
    def add_placeholders(self):
        ...
        self.input_placeholder = tf.placeholder(dtype=tf.int32,shape=(None, self.config.n_window_features),name='input_placeholder')
    ...
    def add_embedding(self):
        ...
        embeddings = tf.reshape(extracted_embeddings,(-1, self.config.n_window_features * self.config.embed_size),name='embeddings')
        ### END YOUR CODE
        return embeddings
    ...
    def add_prediction_op(self):
        ...
        pred = tf.add(tf.matmul(h_drop,U),b2,name='pred')
        ### END YOUR CODE
        return pred
    ...
    def add_loss_op(self, pred):
        ...
        cross_entropy_pred = tf.nn.sparse_softmax_cross_entropy_with_logits(labels=self.labels_placeholder,logits=pred,
                                                                            name='cross_entropy_pred')
        loss = tf.reduce_mean(cross_entropy_pred,name='loss')
        ### END YOUR CODE
        return loss
